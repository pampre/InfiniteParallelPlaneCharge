 ...
 int main(int argc, char* argv[]) {
  ...
  if (argc < 2) {
    std::cout << "Usage: " << argv[0] << " genType seed[optional] parameter[optional] nbits[optional, default=32] r[optional, default=0] s[optional, default=500]\n";
    return 1;
  }
  ...
  bbattery_Alphabit(gen, nbits, r, s);
